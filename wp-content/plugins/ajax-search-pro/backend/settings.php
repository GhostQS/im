...
<div id="wpdreams" class='wpdreams wrap<?php echo isset($_COOKIE['asp-accessibility']) ? ' wd-accessible' : ''; ?>'>
    ...
    <?php if ( !wd_asp()->db->exists('main', true) ): ?>
        <div class="wpdreams-box">
            <p class='errorMsg'>
                <?php echo __('The plugin table(s) are missing, or could not be created!', 'ajax-search-pro'); ?>&nbsp;
                <?php echo sprintf( __('Please check <a href="%s">this article</a> to resolve the issue.', 'ajax-search-pro'),
