...
<fieldset>
	...
	<div class="item">
		<?php
		$o = new wpdreamsTextarea("advtitlefield", __('Advanced Title Field (default: {titlefield})', 'ajax-search-pro'),  $sd['advtitlefield']);
		$params[$o->getName()] = $o->getData();
		?>
        <p class="descMsg">
	...
	<div class="item">
		<?php
		$o = new wpdreamsTextarea("advdescriptionfield", __('Advanced Description Field (default: {descriptionfield})', 'ajax-search-pro'),  $sd['advdescriptionfield']);
		$params[$o->getName()] = $o->getData();
		?>
        <p class="descMsg">
			<?php echo __('HTML is supported! Use {custom_field_name} format to have custom field values.', 'ajax-search-pro'); ?>&nbsp;
