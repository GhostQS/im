...
<div class="item">
    <?php
    $o = new wpdreamsTextarea("kw_exceptions", __('Keyword exceptions - replace anywhere', 'ajax-search-pro'), $sd['kw_exceptions']);
...
<div class="item">
    <?php
    $o = new wpdreamsTextarea("kw_exceptions_e", __('Keyword exceptions - replace whole words only', 'ajax-search-pro'), $sd['kw_exceptions_e']);
    $params[$o->getName()] = $o->getData();
    ?>
