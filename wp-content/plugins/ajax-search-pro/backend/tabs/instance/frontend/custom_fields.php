...
sample_value3||Sample Label 3**</textarea>
        ...
        <div class='one-item asp_f_datepicker asp_f_type'>
            ...
            <p class="greenMsg msg_acf">
                <?php echo sprintf( __('NOTICE: The save format must be <strong>yymmdd</strong> <a href="%s" target="_blank">on the ACF options.</a>', 'ajax-search-pro'), 'http://i.imgur.com/JrSKoGP.png' ); ?>
            </p>
