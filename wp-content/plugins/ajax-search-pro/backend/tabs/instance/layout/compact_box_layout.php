...
<div class="item">
    <?php
    $o = new wpdreamsText("box_compact_width", __('Compact layout final width', 'ajax-search-pro'), $sd['box_compact_width']);
    $params[$o->getName()] = $o->getData();
    ?>
    <p class="descMsg">
...
<div class="item">
    <?php
    $o = new wpdreamsText("box_compact_position_z", __('z-index', 'ajax-search-pro'), $sd['box_compact_position_z']);
    $params[$o->getName()] = $o->getData();
    ?>
    <p class="descMsg">
