...
<div class="item"><?php
    $o = new wpdreamsText("noresultstext", __('No results text', 'ajax-search-pro'), $sd['noresultstext']);
    $params[$o->getName()] = $o->getData();
    ?>
</div>
<div class="item"><?php
    $o = new wpdreamsText("didyoumeantext", __('Did you mean text', 'ajax-search-pro'), $sd['didyoumeantext']);
    $params[$o->getName()] = $o->getData();
    ?>
</div>