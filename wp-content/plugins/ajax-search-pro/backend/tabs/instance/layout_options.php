<ul id="subtabs"  class='tabs'>
    ...
    <li><a tabid="402" class='subtheme'><?php echo __('Results layout', 'ajax-search-pro'); ?></a></li>
...
<div class='tabscontent'>
    ...
    <div tabid="403">
        <fieldset>
            <legend><?php echo __('Results Behaviour', 'ajax-search-pro'); ?></legend>
            <?php include(ASP_PATH."backend/tabs/instance/layout/results_behaviour.php"); ?>
        </fieldset>
    </div>
    <div tabid="404">
        <fieldset>
            <legend><?php echo __('Compact Box layout', 'ajax-search-pro'); ?></legend>
