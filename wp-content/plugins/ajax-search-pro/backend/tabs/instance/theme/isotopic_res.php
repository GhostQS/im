...
<div class="item"><?php
    $o = new wpdreamsTextSmall("i_item_width", __('Result width', 'ajax-search-pro'), $sd['i_item_width']);
    $params[$o->getName()] = $o->getData();
    ?>
    <p class="descMsg">
...
<div class="item"><?php
    $o = new wpdreamsTextSmall("i_item_height", __('Result height', 'ajax-search-pro'), $sd['i_item_height']);
    $params[$o->getName()] = $o->getData();
    ?>px
</div>
<div class="item"><?php
