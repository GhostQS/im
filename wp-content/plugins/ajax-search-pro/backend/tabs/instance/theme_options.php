<ul id="tabs"  class='tabs'>
    ...
    <li><a tabid="605" class='subtheme'><?php echo __('Isotopic Results', 'ajax-search-pro'); ?></a></li>
    <li><a tabid="606" class='subtheme'><?php echo __('Isotopic Navigation', 'ajax-search-pro'); ?></a></li>
    <li><a tabid="607" class='subtheme'><?php echo __('Vertical Results', 'ajax-search-pro'); ?></a></li>
    <li><a tabid="608" class='subtheme'><?php echo __('Horizontal Results', 'ajax-search-pro'); ?></a></li>
    <li><a tabid="609" class='subtheme'><?php echo __('Polaroid Results', 'ajax-search-pro'); ?></a></li>
