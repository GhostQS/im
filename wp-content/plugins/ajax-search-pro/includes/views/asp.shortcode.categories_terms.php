            ...
            if ($display_mode['type'] == "checkboxes") {
                    ...
                    <div class="asp_option_cat asp_option asp_option asp_option_cat_level-0 asp_option_selectall">
                        <div class="asp_option_inner">
                            <input id="asp_<?php echo $ch_class; ?>_all<?php echo $id; ?>"
                                   aria-label="<?php echo asp_icl_t("Select all text [$taxonomy]" . " ($real_id)", $display_mode['select_all_text'], true); ?>"
                                   type="checkbox" data-targetclass="asp_<?php echo $ch_class; ?>_checkbox"
                                <?php echo( ( $display_mode['select_all'] == 1 ) ? 'checked="checked"' : '' ); ?>/>
                            <label aria-hidden="true"
                                   for="asp_<?php echo $ch_class; ?>_all<?php echo $id; ?>"></label>
                        </div>
                    ...
                    <div class="asp_option_cat asp_option asp_option asp_option_cat_level-<?php echo $term->level; ?>"
                        ...
                        <div class="asp_option_inner">
                            <input type="checkbox" value="<?php echo $term->term_id; ?>" class="asp_<?php echo $ch_class; ?>_checkbox"
                                   aria-label="<?php echo esc_html($term->name); ?>"
                                   id="<?php echo $id; ?>termset_<?php echo $term->term_id; ?>"
                                   name="<?php echo $basic_name; ?>[]" <?php echo $checked; ?>/>
                            <label aria-hidden="true"
                                for="<?php echo $id; ?>termset_<?php echo $term->term_id; ?>"></label>
                        </div>
                ...
                if ( $style['show_terms']['separate_filter_boxes'] == 0 ) {
                    ...
                    if ($taxonomy === key($tax_terms)) {
                        echo "<div class='asp_select_label asp_select_single'><select aria-label=\"".asp_icl_t('Taxonomy select', 'Taxonomy select', true)."\" 
                                   data-placeholder='$_sel_placeholder' $_sel_multi class='$_sel_class' name='".$name."'>";
                        echo $term_buff;
                        echo "</select></div>";
                    }
                } else {
                    $term_buff = ob_get_clean();
                    echo "<div class='asp_select_label asp_select_single'><select aria-label=\"".asp_icl_t('Taxonomy select [' . $taxonomy . "] ($real_id)", 'Taxonomy select for ' . $taxonomy, true)."\" 
                               data-placeholder='$_sel_placeholder' $_sel_multi class='$_sel_class' name='".$name."'>";
                    echo $term_buff;
                    echo "</select></div>";
                }
