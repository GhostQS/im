	...
	<div class="ihc-stuffbox">
		...
		<div class="inside">
			...
			<div class="row" style="margin-left:0px;">
					<div class="col-xs-3">
						...
						<div class="row" style="margin-left:0px;">
								<div class="col-xs-3">
										<div class="iump-form-line">
											<h2><?php _e('User Id', 'ihc');?></h2>
														<label class="iump_label_shiwtch" style="margin:10px 0 10px -10px;">
															<?php $checked = ($data['metas']['ihc_membership_member_show_uid']) ? 'checked' : '';?>
															<input type="checkbox" class="iump-switch" onClick="iump_check_and_h(this, '#ihc_membership_member_show_uid');" <?php echo $checked;?> />
															<div class="switch" style="display:inline-block;"></div>
														</label>
			...
			<div class="iump-form-line">
				...
				<textarea name="ihc_membership_card_custom_css" style="width: 100%; height: 150px;"><?php echo stripslashes($data['metas']['ihc_membership_card_custom_css']);?></textarea>
			</div>
