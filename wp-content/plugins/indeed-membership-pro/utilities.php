...
Bank NAME<br/>',
		...
		case 'login-messages':
			$arr = array(
							...
							'ihc_login_error_ajax' => 'Molimo Vas ispunite sva obavezna polja!',
						);
		break;
		...
		case 'register-msg':
			$arr = array(
							...
							'ihc_register_err_req_fields' => 'Molimo Vas ispunite sva obavezna polja!',
...
function ihc_print_form_login($meta_arr){
	...
	case 'ihc-login-template-2':
		...
		if($meta_arr['ihc_login_remember_me']){
			$str .= '<div class="impu-form-line-fr impu-remember-wrapper"><input type="checkbox" value="forever" name="rememberme" class="impu-form-input-remember" /><span class="impu-form-label-fr impu-form-label-remember">'.__('Zapamti me', 'ihc').'</span> </div>';
		}
		//>>>>
	...
	case 'ihc-login-template-3':
		...
		//<<<< REMEMBER ME
		if($meta_arr['ihc_login_remember_me']){
			$str .= '<div class="impu-remember-wrapper"><input type="checkbox" value="forever" name="rememberme" class="impu-form-input-remember" /><span class="impu-form-label-remember">'.__('Zapamti me', 'ihc').'</span> </div>';
		}
		//>>>>
	...
	case 'ihc-login-template-5':
		...
		//<<<< REMEMBER ME
		if($meta_arr['ihc_login_remember_me']){
			$str .= '<div class="impu-remember-wrapper"><input type="checkbox" value="forever" name="rememberme" class="impu-form-input-remember" /><span class="impu-form-label-fr impu-form-label-remember">'.__('Zapamti me', 'ihc').'</span> </div>';
		}
		//>>>>
		//<<<< ADDITIONAL LINKS
		if($meta_arr['ihc_login_register'] || $meta_arr['ihc_login_pass_lost']){
	...
	default:
		...
		//<<<< REMEMBER ME
		if($meta_arr['ihc_login_remember_me']){
			$str .= '<div class="impu-form-line-fr impu-remember-wrapper"><input type="checkbox" value="forever" name="rememberme" class="impu-form-input-remember" /><span class="impu-form-label-fr impu-form-label-remember">'.__('Zapamti me').'</span> </div>';
		}
		//>>>>
