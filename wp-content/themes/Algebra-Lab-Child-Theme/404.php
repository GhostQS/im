...
<section id="content" class="full-width">
	<div id="post-404page">
		<div class="post-content">
			...
			$subtitle = esc_html__( 'Ups, stranica nije pronađena!', 'Avada' );
			...
			<div class="error-page">
				<div class="fusion-columns fusion-columns-3">
					...
					<div class="fusion-column col-lg-4 col-md-4 col-sm-4 useful-links">
						<h3><?php esc_html_e( 'Korisni linkovi', 'Avada' ); ?></h3>
						<?php
					...
					<div class="fusion-column col-lg-4 col-md-4 col-sm-4">
						<h3><?php esc_html_e( 'Prtražite našu stranicu', 'Avada' ); ?></h3>
						<p><?php esc_html_e( 'Pokušajte pretražite našu web stranicu!', 'Avada' ); ?></p>
