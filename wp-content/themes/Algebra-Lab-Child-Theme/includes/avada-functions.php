				...
				if ( $woo_account_page_link ) {
					...
					if ( 'v6' !== $header_layout ) {
						if ( ! is_user_logged_in() ) {
							...
							$items .= '<p class="fusion-remember-checkbox"><label for="fusion-menu-login-box-rememberme"><input name="rememberme" type="checkbox" id="fusion-menu-login-box-rememberme" value="forever"> ' . esc_html__( 'Zapamti me', 'Avada' ) . '</label></p>';
